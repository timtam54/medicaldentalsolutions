<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceWorkOrderList.aspx.cs" Inherits="MDS.Reports.ServiceWorkOrderList" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="800px" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportEmbeddedResource="MDS.Reports.ServiceBasicRpt.rdlc" ReportPath="Reports/ServiceBasicRpt.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>   
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ServiceWorkOrderSearch"  OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
                ...
                <asp:QueryStringParameter Name="BranchID"  QueryStringField="BranchID" Type="Int32" />
                    <asp:QueryStringParameter Name="dataEntryIncompleteOnly"  QueryStringField="dataEntryIncompleteOnly" Type="Boolean" />
    ...
    <asp:QueryStringParameter Name="location"  QueryStringField="location" Type="String" />
     <asp:QueryStringParameter Name="engineerID"  QueryStringField="engineerID" Type="Int32" />
                <asp:QueryStringParameter Name="servicesAfterDate"  QueryStringField="servicesAfterDate" Type="DateTime" />
                    <asp:QueryStringParameter Name="serviceAfterDateFilter"  QueryStringField="serviceAfterDateFilter" Type="Boolean" />
