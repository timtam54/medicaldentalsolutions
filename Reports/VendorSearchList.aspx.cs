...
{
    public partial class VendorSearchList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //string filename = "VendorList.pdf";
        ...
        public static IQueryable<VendorSearchResult> VendorSearch(string vendorNameContains)
        {
            ReportsDBDataContext context = new ReportsDBDataContext();
            context.CommandTimeout = 120;
          
            return context.VendorSearch(vendorNameContains).AsQueryable();
        }
