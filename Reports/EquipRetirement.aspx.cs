...
{
    public partial class EquipRetirement : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               // string filename = "EquipmentRetirement_" + Request.QueryString["BranchID"].ToString() + "_" + Request.QueryString["equipmentID"].ToString() + ".pdf";
        ...
        {
           // string filename = "EquipmentRetirement.pdf";
            ReportGlobal.CreateDownloadFile(Server, ReportViewer1, Response);
