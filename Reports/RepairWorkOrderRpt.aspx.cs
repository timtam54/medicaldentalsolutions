...
{
    public partial class RepairWorkOrderRpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               // string filename = "RepairWorkOrder_" + Request.QueryString["branchID"].ToString() + "_" + Request.QueryString["repairID"].ToString() + ".pdf";
        ...
        {
           // string filename = "RepairWorkOrder.pdf";
            ReportGlobal.CreateDownloadFile( Server, ReportViewer1, Response);
