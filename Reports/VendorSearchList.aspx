<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorSearchList.aspx.cs" Inherits="MDS.Reports.VendorSearchList" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="300px" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportEmbeddedResource="MDS.Reports.VendorResultsList.rdlc" ReportPath="Reports/VendorResultsList.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>   
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="VendorSearch"  OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
                <asp:QueryStringParameter Name="vendorNameContains"  QueryStringField="vendorNameContains" Type="String" />
                       </SelectParameters>
