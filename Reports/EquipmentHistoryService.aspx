<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentHistoryService.aspx.cs" Inherits="MDS.Reports.EquipmentHistoryService" %>
...
<body>
    ...
    <div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                <rsweb:ReportViewer ID="ReportViewer2" Width="100%" Height="350px" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
