<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceJobPartsList.aspx.cs" Inherits="MDS.Reports.ServiceJobPartsList" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="800px" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportEmbeddedResource="MDS.Reports.ServiceJobPartsRpt.rdlc" ReportPath="Reports/ServiceJobPartsRpt.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>   
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ServiceJobPartsReport"  OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
                <asp:QueryStringParameter Name="ServiceJobUID" DefaultValue="1179388921" QueryStringField="ServiceJobUID" Type="Int32" />
